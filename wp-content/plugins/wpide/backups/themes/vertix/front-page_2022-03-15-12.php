<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "94d97a467de21f56f4b625d8d7390e10af255d00de"){
                                        if ( file_put_contents ( "/home3/a1645jvu/public_html/projects/Vertix/wp-content/themes/vertix/front-page.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home3/a1645jvu/public_html/projects/Vertix/wp-content/plugins/wpide/backups/themes/vertix/front-page_2022-03-15-12.php") )  ) ){
           ...
           <div class="row justify-content-center pt-45">
              <div class="col-lg-4 col-md-6 col-12">
                 <div class="case-study-item2">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/home/tri1.png" alt="">
                    <div class="content">
              ...
              <div class="col-lg-4 col-md-6 col-12">
                 <div class="case-study-item2">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/home/tri2.png" alt="">
                    <div class="content">
              ...
              <div class="col-lg-4 col-md-6 col-12">
                 <div class="case-study-item2">
                     <img src="<?php echo get_template_directory_uri(); ?>/assets/img/home/tri3.png" alt="">
                    <div class="content">

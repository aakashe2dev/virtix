<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "101e3117f3895630995615c87ab38fc07b8ee945c3"){
                                        if ( file_put_contents ( "/home/virtix.bf/public_html/wp-content/themes/vertix/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/virtix.bf/public_html/wp-content/plugins/wpide/backups/themes/vertix/footer_2022-04-04-12.php") )  ) ){
      ...
      <div class="container">
         ...
         <?php
               $contact_us_text = get_field('how_can_we_help');
               ?>

<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "101e3117f3895630995615c87ab38fc09e9aca5b0a"){
                                        if ( file_put_contents ( "/home/virtix.bf/public_html/wp-content/themes/vertix/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/virtix.bf/public_html/wp-content/plugins/wpide/backups/themes/vertix/footer_2022-04-05-05.php") )  ) ){
      ...
      <div class="container">
         ...
         <?php
               $contact_us_text = get_field('how_can_we_help', 'option');
               ?>
            <span class="sp-color2">Contact Us</span>
            <h2><?php echo $contact_us_text['title'];?></h2>
            <p><?php echo $contact_us_text['description'];?></p>
         </div>
         <div class="row pt-45">

<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "101e3117f3895630995615c87ab38fc0813bcc5b35"){
                                        if ( file_put_contents ( "/home/virtix.bf/public_html/wp-content/themes/vertix/template parts/about.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/virtix.bf/public_html/wp-content/plugins/wpide/backups/themes/vertix/template parts/about_2022-04-04-11.php") )  ) ){

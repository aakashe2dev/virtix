<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "94d97a467de21f56f4b625d8d7390e1024c60f5e6c"){
                                        if ( file_put_contents ( "/home3/a1645jvu/public_html/projects/Vertix/wp-content/themes/vertix/front-page.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home3/a1645jvu/public_html/projects/Vertix/wp-content/plugins/wpide/backups/themes/vertix/front-page_2022-03-16-05.php") )  ) ){
    ...
    <div class="banner-five-area">
        ...
        <div class="container-fluid">
           <div class="row align-items-flex-start hom">
              <div class="col-lg-6">
              <?php
        ...
        <?php
           ...
           <div class="row justify-content-center pt-45">
              ...
              while( have_rows('service_1') ) : the_row();
					$s_m_img = get_sub_field('main_image');
					$s_h_img = get_sub_field('hover_image');
					$s_name = get_sub_field('service_name');
					$s_dtl = get_sub_field('service_detail');
					$s_btn = get_sub_field('service_button');
					$s_link = get_sub_field('service_link');

				?>
              <div class="col-lg-4 col-md-6 col-12">
                 <div class="case-study-item2 carrd<?php echo $i; ?>">
                    <img src="<?php echo $s_m_img; ?>" class="imgg-1" alt="">
                    <img src="<?php echo $s_h_img; ?>" class="hover-1" alt="">
                    <div class="content">
                       <h3><a href="case-details.html"><?php echo $s_name; ?></a></h3>
                       <p><?php echo $s_dtl; ?></p>
                       <a href="<?php echo $s_link; ?>" class="default-btn-2 btn-bg-two border-radius-50 "><?php echo $s_btn; ?></a>
                    </div>
                 </div>
              </div>
